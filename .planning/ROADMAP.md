...
Plans:
- [x] 02-content-migration/02-01-PLAN.md — MIG-01: scraper foundation (deps, schema fix, orchestrator, libs) + publications parser
- [x] 02-content-migration/02-02-PLAN.md — MIG-02, MIG-03: people parser + events parser
